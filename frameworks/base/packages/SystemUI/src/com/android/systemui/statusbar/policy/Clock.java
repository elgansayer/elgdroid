...
public class Clock extends TextView implements DemoMode {
    ...
    */
    ...
    public Clock(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            mFontScale = Settings.System.getFloat(resolver, STATUSBAR_CLOCK_FONT_SCALE,
                    1.0f);

            mFontStyle = Settings.System.getInt(resolver, STATUSBAR_CLOCK_FONT_STYLE,
                    0);
        } finally {
    ...
    final void updateClock() {
        ...
        mFontStyle = Settings.System.getInt(resolver, STATUSBAR_CLOCK_FONT_STYLE,
                0);
        Log.i("ELGAN SAYER CLOCK", " FOnt scale " + mFontScale);
//setY(-10.0f);

        Log.i("ELGAN SAYER CLOCK", " Text Size right now " + getTextSize());
...
textView.setTypeface(null, Typeface.NORMAL);
        ...
        setTypeface(getTypeface(), mFontStyle);
        setTextSize( TypedValue.COMPLEX_UNIT_SP, mFontScale);
