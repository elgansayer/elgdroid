...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.APP_DISPLAY_OPS_SERVICE, AppDisplayOpsManager.class,
                new CachedServiceFetcher<AppDisplayOpsManager>() {

            @Override
            public AppDisplayOpsManager createService(ContextImpl ctx) {
                IBinder b = ServiceManager.getService(Context.APP_DISPLAY_OPS_SERVICE);
                IAppDisplayOpsService service = IAppDisplayOpsService.Stub.asInterface(b);
                return new AppDisplayOpsManager(ctx, service);
            }});
