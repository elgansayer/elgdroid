...
import com.android.settings.elgan.AppDisplaySettings;
...
public class InstalledAppDetails extends AppInfoBase
    ...
    private static final String KEY_DISPLAY = "display_settings";        
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mDisplayPreference = findPreference(KEY_DISPLAY);
    ...
    protected boolean refreshUi() {
        ...
        mDisplayPreference.setSummary(getDisplaySummary(mAppEntry, context));
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        } else if (preference == mDisplayPreference) {
            startAppInfoFragment(AppDisplaySettings.class,
                    getString(R.string.app_display_title));
    ...
    public static CharSequence getDisplaySummary(AppEntry appEntry, Context context) {
